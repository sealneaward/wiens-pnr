"""make_wiens_sequences_from_games.py

Usage:
    make_wiens_sequences_from_games.py <f_data_config>

Arguments:
    <f_data_config>  example ''wiens.yaml''

Example:
    python make_wiens_sequences_from_games.py wiens.yaml
"""
...
from wiens.data.loader import BaseLoader, WiensSequenceLoader
...
def binarize_features():
    for fold_index in xrange(1):
        ...
        loader = WiensSequenceLoader(dataset, extractor, data_config['batch_size'])
